...
<body>
    ...
    <%
        ...
        int perfil = 3; // Perfil siempre es 3
        ...
        String resultado = usuario.ingresarCliente(); // Suponiendo que tienes un método "ingresarCliente" en tu clase Usuario para realizar el registro.
